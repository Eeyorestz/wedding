	   ...
	   <section id="intro" class="main style1 dark fullscreen">
		...
		<section id="invitation" class="main style2 right dark fullscreen">
			<div class="content box style2">
				<header>
					...
					<p>
						Ти си от избраните от сърцата ни хора, с които желаем да споделим този толкова вълнуващ ден! 
						<br>За нас е истинско удоволствие да бъден наш специален гост на едно от най-вълнуващите събития в живота ни – нашето сватбено тържество. 
						<br>Нека заедно превърнем този ден в един незабравим спомен! 
		...
		<section id="two" class="main style2 right dark fullscreen">
			<div class="content box style2">
				...
				<p>Двама луди, но пък и рогати, чиито души съдбата реши да преплете завинги.
				<br>Точно 4 години, десетки дестинации,  стотици споделени изгреви и залези, хиляди емоции и една Алина по-късно - ние решихме да затворим кръга и да го направим официално! Елате с нас да го отпразнуваме!</p>
			</div>
		...
		<section id="bestmans" class="main style2 right dark fullscreen">
			<div class="content box style2">
				...
				<p>Петя и Павел Гюрушеви<p/>
				<p>През реки, потоци, бари, ручеи пенливи,
					<br>ходят, бродят, наще кумуве нетърпеливи - 
					<br>да орисат и да слеят двете ни души в едно,
					<br>Пепи, Пако са готови винаги за нас с добро! 
				</p>
			</div>
        ...
        <div class="content">
            <header>
                ...
                <p><b>Има ли специален дрескод?</b></p>
                ...
                <p>- Комплексът разполага със собствен паркинг с достатъчно паркоместа. За тези, които искат да вземат колите си преди 14:00 на следващия ден, моля паркирайте извън двора на комплекса, като там трябва да има достатъчно места.</p>
                ...
                <p><b>Какви подаръци бихте желали?</b></p>
                <a href="~/images/thumbs/03.gif" class="image fit"><img src="images/thumbs/03.gif" title="Airchitecture II" alt="" /></a>

                <p><b>Кога ще се поднасят поздравленията и подаръците?</b></p>
                <p>- Веднага след изнесения ритуал.</p>

                <p><b>Да носим ли цветя и букети?</b></p>
                ...
                <p><b>Такси:</b></p>
                <p>- В случай че се нуждаете от такси и не знаете номера на таксиметрови компании, това може да ви е от полза:</p>
				
				<p><a href="tel:0329999">0329999</a></p>
				<p><a href="tel:0326665">0326665</a></p>
				<p><a href="tel:0329199">0329199</a></p>
